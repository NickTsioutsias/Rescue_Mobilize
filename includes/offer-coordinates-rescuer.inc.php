<?php
  // In this file we convert donation data to a JSON file
  ...
  ST_X(donation.location) as lng,
  ST_Y(donation.location) as lat,
  ...
  if (!mysqli_stmt_prepare($stmt, $sql)) {
    ...
    file_put_contents('Donations.json', $encoded_data);
